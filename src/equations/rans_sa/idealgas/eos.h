...
#define CONS 1:6  /* conservative variables */
#define PRIM 7:13 /* primitive variables */
...
#define SRHO  7   /* specific volume (1./density) */
#define VEL1  8   /* velocity x */
#define VEL2  9   /* velocity y */
#define VEL3  10   /* velocity z */
#define VELV  8:10 /* velocity range */
#define PRES  11  /* pressure */
#define TEMP  12  /* temperature */
#define NUSA  13  /* turbulent nu */
