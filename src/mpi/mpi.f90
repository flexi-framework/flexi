...
#if FV_ENABLED
ALLOCATE(MPIRequest_FV_ElemsSM(nNbProcs,2) )
ALLOCATE(MPIRequest_FV_ElemsMS(nNbProcs,2) )
ALLOCATE(MPIRequest_FV_gradU(nNbProcs,2) )
MPIRequest_FV_ElemsSM = MPI_REQUEST_NULL
MPIRequest_FV_ElemsMS = MPI_REQUEST_NULL
...
#if FV_ENABLED
SDEALLOCATE(MPIRequest_FV_ElemsSM)
SDEALLOCATE(MPIRequest_FV_ElemsMS)
