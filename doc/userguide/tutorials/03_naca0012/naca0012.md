...
A sample parameter file is included in the NACA0012 tutorial folder. You need to specify the *Mesh*-file that should be used to create the record points and a project name. The options *NSuper* and *maxTolerance* control the algorithm that tries to find
