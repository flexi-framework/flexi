...
IF(NOT LIBS_BUILD_HDF5)
  ...
  IF(NOT "${HDF5_C_LIBRARY_hdf5_c}" STREQUAL "")
    IF(APPLE)
      EXECUTE_PROCESS(COMMAND nm -g       ${HDF5_C_LIBRARY_hdf5_c} COMMAND grep inflate OUTPUT_VARIABLE HDF5_USES_ZLIB RESULT_VARIABLE GREP_RESULT OUTPUT_STRIP_TRAILING_WHITESPACE)
    ELSE()
